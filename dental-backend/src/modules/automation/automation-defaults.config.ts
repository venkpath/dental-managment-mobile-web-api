/**
 * Default automation rules seeded when a clinic is onboarded or first opens
 * Automation settings. Template names resolve to system MessageTemplate rows
 * (clinic_id = null) at seed time.
 */
...
export interface AutomationRuleDefault {
  ...
  is_enabled: boolean;
  channel: string;
  /** System template_name for rule.template_id */
  template_name?: string;
  config: Record<string, unknown>;
  /** appointment_reminder_patient — per-slot template names */
  reminder_template_names?: { 1?: string; 2?: string };
}

/** System WhatsApp template names used as onboarding defaults (see screenshots). */
export const AUTOMATION_DEFAULT_TEMPLATES = {
...
export const CLINIC_AUTOMATION_DEFAULTS: AutomationRuleDefault[] = [
  {
  ...
  },
  {
    ...
    is_enabled: true,
    channel: 'preferred',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.noshow_followup,
    config: { delay_hours: 1 },
  },
  {
  ...
  },
  {
    ...
    is_enabled: false,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.treatment_plan_reminder,
  ...
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.untreated_condition_reminder,
    config: {
  ...
  },
  {
    ...
    reminder_template_names: {
      1: AUTOMATION_DEFAULT_TEMPLATES.appointment_reminder,
      2: AUTOMATION_DEFAULT_TEMPLATES.appointment_reminder,
    },
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.appointment_confirmation,
    config: {},
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.appointment_cancellation,
    config: {},
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.appointment_rescheduled,
    config: {},
  },
  {
    ...
    is_enabled: true,
    channel: 'preferred',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.payment_confirmation,
    config: {},
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.invoice_ready,
    config: {},
  },
  {
  ...
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.prescription_ready,
    config: {},
  },
  {
  ...
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.appointment_confirmation_dentist,
    config: {},
  },
  {
    ...
    is_enabled: true,
    channel: 'whatsapp',
    template_name: AUTOMATION_DEFAULT_TEMPLATES.appointment_reminder_dentist,
    config: { hours: 2 },
  },
  {
...
export function getAllAutomationRuleTypes(): string[] {
  return CLINIC_AUTOMATION_DEFAULTS.map((d) => d.rule_type);
}
