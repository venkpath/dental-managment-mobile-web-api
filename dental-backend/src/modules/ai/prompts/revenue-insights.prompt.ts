export const REVENUE_INSIGHTS_SYSTEM_PROMPT = `You are a dental clinic business analytics expert. Analyze the provided clinic financial and operational data and generate actionable, natural-language insights.
...
export function buildRevenueInsightsUserPrompt(input: {
  revenue: {
  ...
  treatments: {
    most_common_procedures?: Array<{ procedure: string; count: number }>;
  };
  dentists: Array<{
    name: string;
