...
const DEFAULT_TEMPLATES: TemplateSeed[] = [
  ...
  // ── 17b. AI Insights — Treatment follow-up (recall list) ──
  // Meta-approved bodies — do not edit without re-syncing from WhatsApp Manager.
  {
    channel: 'whatsapp',
    category: 'marketing',
    template_name: 'dental_treatment_followup_due',
    body: 'Hi {{1}},\n\nIt\'s been {{3}} since your *{{2}}* at {{4}}.\n\nYour follow-up visit is now due. *A follow-up visit helps ensure your treatment is progressing well.*.\n\nBook your appointment here:\n{{5}}\n\nNeed help booking an appointment? Call us at *{{6}}* for assistance.',
    variables: { body: ['1', '2', '3', '4', '5', '6'], buttons: [] },
    language: 'en',
    sampleValues: { '1': 'Priya Sharma', '2': 'Scaling', '3': '14 days', '4': 'Smile Dental Clinic', '5': 'https://www.smartdentaldesk.com/booking/clinic-id/branch-id', '6': '9876543210' },
  },
  {
    channel: 'whatsapp',
    category: 'utility',
    template_name: 'dental_treatment_followup_overdue',
    body: 'Hi {{1}},\n\nYour follow-up visit after {{2}} at {{3}} is overdue by {{4}} days.\n\nA timely follow-up can help address any concerns early and keep your treatment on track.\n\nBook your appointment here:\n{{5}}\n\nNeed help booking an appointment? Call us at *{{6}}* for assistance.',
    variables: { body: ['1', '2', '3', '4', '5', '6'], buttons: [] },
    language: 'en',
    sampleValues: { '1': 'Priya Sharma', '2': 'Scaling', '3': 'Smile Dental Clinic', '4': '40', '5': 'https://www.smartdentaldesk.com/booking/clinic-id/branch-id', '6': '9876543210' },
  },

  // ── 17c. AI Insights — Patient re-engagement (inactive list) ──
  {
    channel: 'whatsapp',
    category: 'marketing',
    template_name: 'dental_reengagement_soft',
    body: 'Hi {{1}},\n\nIt\'s been a while since your last visit to *{{2}}*. We hope you\'re doing well.\n\nA quick check-up can catch things early and keep your smile healthy.\n\nBook here: {{3}}\n\nNeed help booking an appointment? Call us at *{{4}}* for assistance.',
    variables: { body: ['1', '2', '3', '4'], buttons: [] },
    language: 'en',
    sampleValues: { '1': 'Priya Sharma', '2': 'Smile Dental Clinic', '3': 'https://www.smartdentaldesk.com/booking/clinic-id/branch-id', '4': '9876543210' },
  },
  {
    channel: 'whatsapp',
    category: 'marketing',
    template_name: 'dental_reengagement_offer',
    body: 'Hi {{1}},\n\nWe miss you at *{{2}}*! Since it\'s been some time, we\'re offering *{{3}}*.\n\nRegular check-ups help keep your teeth and gums healthy and can prevent bigger problems later.\n\nSlots are limited — book yours:\n{{4}}\n\nNeed help booking an appointment? Call us at *{{5}}* for assistance.',
    variables: { body: ['1', '2', '3', '4', '5'], buttons: [] },
    language: 'en',
    sampleValues: { '1': 'Priya Sharma', '2': 'Smile Dental Clinic', '3': '20% off on your next visit', '4': 'https://www.smartdentaldesk.com/booking/clinic-id/branch-id', '5': '9876543210' },
  },
