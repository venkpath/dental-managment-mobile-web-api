...
const super_admin_decorator_js_1 = require("../decorators/super-admin.decorator.js");
let SuperAdminGuard = class SuperAdminGuard {
    ...
    canActivate(context) {
        const isSuperAdmin = this.reflector.getAllAndOverride(super_admin_decorator_js_1.IS_SUPER_ADMIN_KEY, [context.getHandler(), context.getClass()]);
        if (!isSuperAdmin) {
            return true;
        }
