...
const audit_log_controller_js_1 = require("./audit-log.controller.js");
...
exports.AuditLogModule = AuditLogModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        controllers: [audit_log_controller_js_1.AuditLogController],
        providers: [audit_log_service_js_1.AuditLogService],
        exports: [audit_log_service_js_1.AuditLogService],
    })
], AuditLogModule);
