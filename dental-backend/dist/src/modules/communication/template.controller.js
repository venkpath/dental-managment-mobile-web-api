...
__decorate([
    ...
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Plan does not include CUSTOM_TEMPLATES — upgrade to Growth to create your own templates' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, require_feature_decorator_js_1.RequireFeature)('CUSTOM_TEMPLATES'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a message template (Growth plan only)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Plan does not include CUSTOM_TEMPLATES — upgrade to Growth to edit your own templates' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_clinic_decorator_js_1.CurrentClinic)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Plan does not include CUSTOM_TEMPLATES — upgrade to Growth to delete your own templates' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_clinic_decorator_js_1.CurrentClinic)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
