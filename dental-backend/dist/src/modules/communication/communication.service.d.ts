...
export declare class CommunicationService {
    ...
    completeWhatsAppEmbeddedSignup(clinicId: string, code?: string, accessToken?: string, sessionPhoneNumberId?: string, sessionWabaId?: string, redirectUri?: string): Promise<{
        success: boolean;
        waba_id: string;
