...
export declare class InsuranceProvidersController {
    private readonly providers;
    constructor(providers: InsuranceProvidersService);
    list(clinicId: string, country?: string, type?: string): Promise<({
        plans: ({
            _count: {
    ...
    getPlan(clinicId: string, id: string): Promise<{
        provider: {
            id: string;
            name: string;
            created_at: Date;
