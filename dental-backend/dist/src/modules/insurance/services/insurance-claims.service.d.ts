...
export declare class InsuranceClaimsService {
    ...
    findByInvoice(invoiceId: string, clinicId: string): Promise<({
        attachments: {
            id: string;
            description: string | null;
            type: string;
    ...
    submit(id: string, clinicId: string, dto: SubmitClaimDto, userId: string): Promise<{
        attachments: {
            id: string;
            description: string | null;
            type: string;
    ...
    updateStatus(id: string, clinicId: string, dto: UpdateClaimStatusDto, userId: string): Promise<{
        attachments: {
            id: string;
            description: string | null;
            type: string;
    ...
    recordPayment(id: string, clinicId: string, dto: RecordClaimPaymentDto, userId: string): Promise<{
        attachments: {
            id: string;
            description: string | null;
            type: string;
    ...
    assertOwnership(id: string, clinicId: string): Promise<void>;
}
