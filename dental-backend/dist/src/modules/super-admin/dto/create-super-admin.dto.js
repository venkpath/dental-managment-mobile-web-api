...
class CreateSuperAdminDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 255 }, email: { required: true, type: () => String, maxLength: 255, format: "email" }, password: { required: true, type: () => String, minLength: 8 } };
    }
}
exports.CreateSuperAdminDto = CreateSuperAdminDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Platform Admin', maxLength: 255 }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(255),
    __metadata("design:type", String)
], CreateSuperAdminDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin@dental-saas.com', maxLength: 255 }),
