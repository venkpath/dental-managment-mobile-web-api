...
exports.TreatmentAnalyticsQueryDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const swagger_1 = require("@nestjs/swagger");
class TreatmentAnalyticsQueryDto {
    start_date;
    end_date;
    branch_id;
    dentist_id;
...
exports.TreatmentAnalyticsQueryDto = TreatmentAnalyticsQueryDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Start date (YYYY-MM-DD)', example: '2026-03-01' }),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], TreatmentAnalyticsQueryDto.prototype, "start_date", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'End date (YYYY-MM-DD)', example: '2026-03-31' }),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], TreatmentAnalyticsQueryDto.prototype, "end_date", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by branch UUID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], TreatmentAnalyticsQueryDto.prototype, "branch_id", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by dentist UUID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], TreatmentAnalyticsQueryDto.prototype, "dentist_id", void 0);
//# sourceMappingURL=treatment-analytics-query.dto.js.map