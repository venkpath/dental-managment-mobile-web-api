...
let ReportsController = class ReportsController {
    ...
    async getDashboardBootstrap(clinicId, user, branchId, daysParam) {
        const dentistId = (0, dentist_scope_util_js_1.isDentistUser)(user) ? user.sub : undefined;
...
__decorate([
    (0, common_1.Get)('dashboard-bootstrap'),
    (0, swagger_1.ApiOperation)({
        summary: 'Single-call payload for the dashboard above-the-fold widgets',
        description: 'Returns dashboard summary + sparklines + today\'s appointments in one response. Use this in place of the three separate calls to cut cross-region latency.',
    }),
    (0, swagger_1.ApiOkResponse)({ description: 'Combined dashboard bootstrap payload' }),
    ...
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getDashboardBootstrap", null);
__decorate([
