...
exports.XRAY_ANALYSIS_SYSTEM_PROMPT = void 0;
exports.buildXrayAnalysisUserPrompt = buildXrayAnalysisUserPrompt;
exports.XRAY_ANALYSIS_SYSTEM_PROMPT = `You are a senior dental radiologist with 20+ years of experience interpreting dental radiographs. You are assisting a dentist by analyzing a dental X-ray image.
...
function buildXrayAnalysisUserPrompt(params) {
    ...
    if (params.patient_name)
        prompt += `Patient: ${params.patient_name}\n`;
    if (params.patient_age)
        prompt += `Age: ${params.patient_age} years\n`;
    if (params.patient_gender)
        prompt += `Gender: ${params.patient_gender}\n`;
    if (params.notes)
...
//# sourceMappingURL=xray-analysis.prompt.js.map