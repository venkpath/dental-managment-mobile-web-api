...
class QueryNotificationDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { type: { required: false, type: () => String }, is_read: { required: false, type: () => Boolean }, page: { required: false, type: () => Number, minimum: 1 }, limit: { required: false, type: () => Number, minimum: 1, maximum: 100 } };
    }
}
...
], QueryNotificationDto.prototype, "is_read", void 0);
__decorate([
