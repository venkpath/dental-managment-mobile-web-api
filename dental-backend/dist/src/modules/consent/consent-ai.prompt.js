...
exports.CONSENT_TEMPLATE_SYSTEM_PROMPT = exports.SUPPORTED_CONSENT_LANGUAGES = void 0;
exports.buildConsentTemplateUserPrompt = buildConsentTemplateUserPrompt;
exports.SUPPORTED_CONSENT_LANGUAGES = [
...
exports.CONSENT_TEMPLATE_SYSTEM_PROMPT = `You are an experienced Indian dental clinical writer. Generate a legally robust, patient-friendly informed-consent template for a dental procedure, in the requested target language.
...
- Output JSON only.`;
function buildConsentTemplateUserPrompt(input) {
    const lines = [
...
//# sourceMappingURL=consent-ai.prompt.js.map