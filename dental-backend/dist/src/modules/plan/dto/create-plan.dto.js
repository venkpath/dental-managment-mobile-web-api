...
class CreatePlanDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 100 }, price_monthly: { required: true, type: () => Number, minimum: 0 }, max_branches: { required: true, type: () => Number, minimum: 1 }, max_staff: { required: true, type: () => Number, minimum: 1 }, ai_quota: { required: false, type: () => Number, minimum: 0 } };
    }
}
