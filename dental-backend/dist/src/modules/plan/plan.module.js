...
const plan_controller_js_1 = require("./plan.controller.js");
...
exports.PlanModule = PlanModule = __decorate([
    (0, common_1.Module)({
        controllers: [plan_controller_js_1.PlanController],
        providers: [plan_service_js_1.PlanService],
        exports: [plan_service_js_1.PlanService],
    })
], PlanModule);
