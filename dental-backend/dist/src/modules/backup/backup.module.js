...
const backup_controller_js_1 = require("./backup.controller.js");
...
exports.BackupModule = BackupModule = __decorate([
    (0, common_1.Module)({
        controllers: [backup_controller_js_1.BackupController],
        providers: [backup_service_js_1.BackupService],
        exports: [backup_service_js_1.BackupService],
    })
], BackupModule);
